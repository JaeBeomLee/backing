...
public class recommendTabFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new recommendTabFragmentAdapter();
    ...
    private void teamListEnd(){
        ...
        try{
            ...
            leader_idx = new String[teamArray.length()];
            mainBackgroundUrl = new String[teamArray.length()];
            mainTeamLogoUrl = new String[teamArray.length()];
            for (int i = 0; i<teamArray.length(); i++){
                ...
                mainTeamLogoUrl[i] = array[i].getString("profileimg");
                mainBackgroundUrl[i] = array[i].getString("coverimg");
            }
    ...
    private recommendTabFragmentMainData createMainList(String name, String logo, String cover){
        recommendTabFragmentMainData main = new recommendTabFragmentMainData();
