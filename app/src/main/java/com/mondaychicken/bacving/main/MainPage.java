...
import com.mondaychicken.bacving.main.soccer.mainTabFragment2;
...
import com.mondaychicken.bacving.teamPlayer.create.createActivity;
...
public class MainPage extends AppCompatActivity implements DrawerLayout.DrawerListener {
    ...
    MenuItem searchMenu;
    String userEmail= null, userno = null, userPw= null, userName= null, userProfileimg= null, userStatus= null, userGrade= null, userToken= null;
    LinearLayout header;
    TextView headerName;
    TextView textView;
